  ...
  Widget build(BuildContext context) {
    final cardItems = [
      ...
      },
      {
        ...
        'onTap': () => Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => SeminarsScreen()),
        ),
      },
      {
        'title': 'Fests',
        ...
        'onTap': () => Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => FestsScreen()),
        ),
      },
      {
        'title': 'Notices',
  ...
  final List<Map<String, String>> events = [
    {
      ...
      'location': 'Auditorium',
      'description':
          'An annual technical festival with coding, robotics, and innovation challenges.',
    },
    {
      'title': 'Seminar on AI',
      'date': 'August 20, 2025',
      'location': 'Room 204',
      'description':
          'A session with industry experts discussing the latest in AI and ML.',
    },
    {
      'title': 'Cultural Fest',
      ...
      'description':
          'Dance, Music, Drama — all in one place. Let the culture shine!',
    },
  ];
